...
// Heading
$_['heading_title'] = 'ecomprocessing Direct';
...
$_['text_edit']     		   = 'Edit ecomprocessing Direct';
$_['text_yes']      		   = 'Yes';
$_['text_no']       	       = 'No';
$_['text_required'] 		   = 'This field is required!';
$_['text_ecomprocessing_direct'] = '<a href="https://e-comprocessing.com/" target="_blank">
    <img src="' . HTTP_CATALOG  . 'image/ecomprocessing.png" alt="ecomprocessing" title="ecomprocessing" style="border: 1px solid #EEEEEE;" />
</a>';
...
$_['help_token']                                     = 'This is your Gateway token. If you do not have a token, contact tech-support@e-comprocessing.com to enable Smart Router for your account.';
