...
namespace Opencart\Extension\Ecomprocessing\System\Admin;
...
abstract class BaseController extends Controller
{
	 ...
	 * @var null|string
	 */
	protected $route_prefix = "extension/ecomprocessing/";
	...
	protected function processGetIndexAction(): void {
		...
		if ($this->isModuleRequiresSsl() && !EcomprocessingHelper::isSecureConnection($this->request)) {
	...
	protected function addExternalResource($resource_name): bool {
		...
		if ($resource_name == 'treeGrid') {
			$this->document->addStyle(HTTP_CATALOG . $this->route_prefix . 'admin/view/javascript/ecomprocessing/treegrid/css/jquery.treegrid.css');
			$this->document->addScript(HTTP_CATALOG . $this->route_prefix . 'admin/view/javascript/ecomprocessing/treegrid/js/jquery.treegrid.js');
			$this->document->addScript(HTTP_CATALOG . $this->route_prefix . 'admin/view/javascript/ecomprocessing/treegrid/js/jquery.treegrid.bootstrap3.js');
		} else if ($resource_name == 'bootstrapValidator') {
			$this->document->addStyle(HTTP_CATALOG . $this->route_prefix . 'admin/view/javascript/ecomprocessing/bootstrap/css/bootstrapValidator.min.css');
			$this->document->addScript(HTTP_CATALOG . $this->route_prefix . 'admin/view/javascript/ecomprocessing/bootstrap/js/bootstrapValidator.min.js');
